...
export default function CartPage() {
    ...
    const [orderPaymentStatusBoxVisible, setOrderPaymentStatusBoxVisible] = useState(Boolean(location.state?.paymentStatus))
    ...
    const totalCartPrice = useMemo(() =>
            cart.reduce((acc: number, cartItem: CartItem) =>
